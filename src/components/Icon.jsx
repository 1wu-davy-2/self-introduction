// 内联 SVG 线性图标（描边继承 currentColor），无需外部图片
const PATHS = {
  code: (
    <>
  ...
  activity: (
    <polyline points="2 12 6.5 12 9.5 5 14 19 17 12 22 12" />
  ),
  database: (
    <>
  ...
  shield: (
    <path d="M12 2.5l7.5 3.5v6c0 4.8-3.2 8.2-7.5 9.5-4.3-1.3-7.5-4.7-7.5-9.5v-6z" />
  ),
  star: (
